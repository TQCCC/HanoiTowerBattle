...
import com.tqc.game.SmallGame;
import com.tqc.socket.GameUDPSocket;
...
//				int remotePort = Integer.parseInt(txtRemotePort.getText());
		...
		spinnerPlateCount.getModel().addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
				/* spinnerPlateCount changed */
				int count = (int) (((SpinnerModel) e.getSource()).getValue());
		...
		btnStart.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (isBattle) {
					...
					if (timer.isRunning()) { // In game, replay.
